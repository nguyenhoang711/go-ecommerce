...
SELECT user_id, user_account, user_nickname, user_avatar, user_state, user_mobile, user_gender, user_birthday, user_email, user_is_authentication, created_at, updated_at FROM pre_go_acc_user_9999 WHERE user_account LIKE ? OR user_nickname LIKE ?
`
...
func (q *Queries) FindUsers(ctx context.Context, arg FindUsersParams) ([]PreGoAccUser9999, error) {
	rows, err := q.db.QueryContext(ctx, findUsers, arg.UserAccount, arg.UserNickname)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var items []PreGoAccUser9999
	for rows.Next() {
...
func (q *Queries) GetUser(ctx context.Context, userID uint64) (PreGoAccUser9999, error) {
...
func (q *Queries) GetUsers(ctx context.Context, userID uint64) ([]PreGoAccUser9999, error) {
...
SELECT user_id, user_account, user_nickname, user_avatar, user_state, user_mobile, user_gender, user_birthday, user_email, user_is_authentication, created_at, updated_at FROM pre_go_acc_user_9999 LIMIT ? OFFSET ?
`
...
func (q *Queries) ListUsers(ctx context.Context, arg ListUsersParams) ([]PreGoAccUser9999, error) {
